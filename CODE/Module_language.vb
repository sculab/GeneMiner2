Module Module_Language
    Public Sub to_en()
        ...
        form_config_combine.Label1.Text = "Cluster difference >"
        form_config_combine.Label2.Text = "Number of samples <"
        ...
        form_config_calculate.Label12.Text = "Cluster Diff."
    ...
    Public Sub to_ch()
        ...
        form_config_combine.Label1.Text = "聚类差异限值"
        form_config_combine.Label2.Text = "最小样本数量"
        ...
        form_config_calculate.Label12.Text = "聚类差异限值"
