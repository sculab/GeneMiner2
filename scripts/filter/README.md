...
2. Download and unpack [zlib](https://zlib.net/). Open x64 Native Tools Command Prompt for Visual Studio and locate zlib's source directory. Build with `nmake /f win32\Makefile.msc`. Create a `bin` directory here and copy the generated `zlib.lib` in there.
