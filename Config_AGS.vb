...
Public Class Config_AGS
    ...
    Public Sub But1()
        ...
        SI_build_database.Arguments += " -c " + TextBox1.Text
        SI_build_database.Arguments += " -exclude " + TextBox1.Text
        Dim process_build_gb As Process = Process.Start(SI_build_database)
        process_build_gb.WaitForExit()
        process_build_gb.Close()
        If My.Computer.FileSystem.DirectoryExists(currentDirectory + "temp\ags_seq\353gene") Then
